...
def test_build_market_calendars_return_types():
    ...
    calendar, us_holidays, fed_events = build_market_calendars(fed_dates)
...
def test_fed_event_dates_conversion():
    ...
    _, _, fed_events = build_market_calendars(fed_dates)
...
def test_invalid_date_format():
    ...
    with pytest.raises(ValueError):
        build_market_calendars(fed_dates)
